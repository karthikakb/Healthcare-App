class PatientsFeedbackController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @patient_feedback.save
        format.html { redirect_to patients_feedback_index_path, notice: "Patient feedback was successfully created." }
        format.json { render :index, status: :created, location: patients_feedback_index_path }
      else
  ...
  def update
    respond_to do |format|
      if @patient_feedback.update(patient_feedback_params)
        format.html { redirect_to patients_feedback_index_path, notice: "Patient feedback was successfully updated." }
        format.json { render :index, status: :ok, location: patients_feedback_index_path }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to patients_feedback_index_path, notice: "Patient feedback was successfully destroyed." }
